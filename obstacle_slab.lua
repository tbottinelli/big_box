...
function define_args(parser)
    parser:add_argument("output,o", {type = "string", action = parser.action.substitute_date_time,
        default = "obstacle_slab.h5" , help = "prefix of output files"})
    ...
    parser:add_argument('slab', {type = 'number', default = 0.4, help = 'box fraction occupied'})
    parser:add_argument('pore_diameter', {type = 'number', default = 15, help = 'pore diameter'})
